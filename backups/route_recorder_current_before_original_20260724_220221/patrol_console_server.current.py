...
ROUTE_TURN_SPACING = 0.30
ROUTE_TURN_EXIT_DISTANCE = 0.40
ROUTE_TURN_ZONE_DISTANCE = 0.50
...
def act_start_recorder(p):
    ...
    inner = (
        ...
        f"-p route_file:={path} "
        f"-p min_distance:={ROUTE_NORMAL_SPACING:.2f} "
        f"-p turn_distance:={ROUTE_TURN_SPACING:.2f} "
        f"-p turn_exit_distance:={ROUTE_TURN_EXIT_DISTANCE:.2f} "
        f"-p turn_zone_distance:={ROUTE_TURN_ZONE_DISTANCE:.2f}"
    )
