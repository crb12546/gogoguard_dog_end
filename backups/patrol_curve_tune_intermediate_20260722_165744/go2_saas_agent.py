...
def start_patrol_command(route_path, params, route_info=None):
    ...
    follower_cmd = (
        ...
        "-p lateral_velocity_ki:=0.030 -p lateral_velocity_kd:=0.020 "
        "-p lateral_velocity_integral_vy_limit:=0.030 "
        "-p lateral_velocity_derivative_vy_limit:=0.010 "
        ...
        "-p curve_heading_blend:=0.350 -p curve_yaw_gain_scale:=0.900 "
