...
def start_patrol_command(route_path, params, route_info=None):
    ...
    follower_cmd = (
        ...
        "-p lateral_velocity_ki:=0.050 -p lateral_velocity_kd:=0.040 "
        "-p lateral_velocity_integral_vy_limit:=0.040 "
        "-p lateral_velocity_derivative_vy_limit:=0.020 "
