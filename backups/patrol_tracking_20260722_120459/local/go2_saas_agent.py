...
def start_patrol_command(route_path, params, route_info=None):
    ...
    max_lateral_yaw_rate = bounded_float(
        params.get("maxLateralYawRate", params.get("max_lateral_yaw_rate", params.get("maxLateralCorrection", params.get("max_lateral_correction", 0.12)))),
        0.12,
        0.0,
        0.45,
    )
    ...
    follower_cmd = (
        ...
        "-p lateral_velocity_deadband:=0.030 -p lateral_velocity_heading_limit_deg:=15.0 "
        ...
        "-p lookahead_corner_scan_distance:=2.200 -p corner_exit_distance:=0.600 "
        "-p corner_wiggle_distance:=1.600 -p corner_wiggle_min_opposite_angle_deg:=30.0 "
        "-p corner_heading_blend:=0.300 -p corner_lateral_yaw_gain_scale:=0.300 "
