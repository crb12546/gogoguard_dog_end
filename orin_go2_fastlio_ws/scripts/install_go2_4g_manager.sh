...
Environment=GO2_4G_USB_UNSTABLE_SETTLE_SECONDS=30
Environment=GO2_4G_USB_ABSENT_RESCAN_AFTER_SECONDS=120
Environment=GO2_4G_USB_ABSENT_RESCAN_INTERVAL_SECONDS=300
Environment=GO2_4G_RADIO_OFF_SECONDS=30
Environment=GO2_4G_STATE_FILE=/run/go2-4g-manager-state.json
Environment=GO2_4G_AUTO_REBOOT_ON_FATAL=1
Environment=GO2_4G_FATAL_REBOOT_DELAY_SECONDS=30
Environment=GO2_4G_FATAL_REBOOT_MAX_BURST=3
Environment=GO2_4G_FATAL_REBOOT_BACKOFF_SECONDS=900
Environment=GO2_4G_FATAL_REBOOT_STABLE_ONLINE_SECONDS=600
Environment=GO2_4G_RECOVERY_JOB_END_GRACE_SECONDS=120
Environment=GO2_4G_REBOOT_MARKER=/var/lib/go2-4g-manager/last-auto-reboot.json
Environment=GO2_4G_FAULT_LOG=/home/unitree/go2_fastlio_ws/patrol_logs/service/go2-4g-faults.jsonl
