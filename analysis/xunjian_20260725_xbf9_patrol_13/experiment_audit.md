...
- 生成时间：2026-07-25T19:53:40.463+08:00
- 运行目录：`/home/unitree/go2_fastlio_ws/patrol_logs/runs/20260725/xunjian-20260725-13`
- 证据流是否完整：是
- 完整体检材料是否齐全：否
...
- 坐标转换可精确复算：是
- 起步位置误差：0.004 m；起步朝向误差：0.009°
- 全程横向误差：中位 5.027 m，P95 6.108 m，最大 6.126 m
- 前 5m 横向误差：P95 0.215 m，最大 0.233 m
- 跟线器逐周期证据：6701 条控制决策、使用 3101 个里程计回调；同一里程计连续复用最多 21 个控制周期；里程计时间戳年龄 P95 324.7 ms
- 全速 rosbag 关键话题：齐全；各话题消息数={"/Odometry": 3236, "/api/sport/request": 7246, "/cmd_vel": 7030, "/lf/sportmodestate": 7140, "/livox/imu": 71230, "/patrol_cmd": 6946, "/tf": 3236}
- rosbag 里程计最大记录间隔：1.032 s
- FAST-LIO 活性事件：自动恢复 0 次，健康失败 0 次，永久锁死 0 次
- 安全层把非零命令改成零：1 次（配对命令 4228 条）
- 性能采样：365 条；最高温度 64.5°C；监控唤醒延迟 P95 4.4 ms
...
- FAST-LIO 多核证据：进程 CPU 峰值 76%，线程数最多 11，线程实际落到的 CPU=[0, 1, 2, 3, 4, 5, 6, 7]，允许 CPU=["0-7"]
...
- FAST-LIO 与狗身 IMU 相对姿态：可比较；相对 R/P/Y 中位数=25.25°/8.15°/38.44°；相对姿态变化 P95=38.64°/31.52°/21.05°
- 狗底层：电机最高温度 54°C；电池功率 P95 187.5W；Sport 非零错误 4641 条；motor lost 0 条
