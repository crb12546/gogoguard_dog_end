...
- 生成时间：2026-07-25T16:45:34.731+08:00
- 运行目录：`/home/unitree/go2_fastlio_ws/patrol_logs/runs/20260725/xunjian-20260725-10`
- 证据流是否完整：是
- 完整体检材料是否齐全：否
...
- 坐标转换可精确复算：是
- 起步位置误差：0.004 m；起步朝向误差：0.038°
- 全程横向误差：中位 0.068 m，P95 0.117 m，最大 0.201 m
- 前 5m 横向误差：P95 0.087 m，最大 0.091 m
- 跟线器逐周期证据：7102 条控制决策、使用 3417 个里程计回调；同一里程计连续复用最多 8 个控制周期；里程计时间戳年龄 P95 285.2 ms
- 全速 rosbag 关键话题：齐全；各话题消息数={"/Odometry": 3597, "/api/sport/request": 7394, "/cmd_vel": 7391, "/lf/sportmodestate": 7484, "/livox/imu": 74658, "/patrol_cmd": 7306, "/tf": 3597}
- rosbag 里程计最大记录间隔：0.386 s
- FAST-LIO 活性事件：自动恢复 0 次，健康失败 0 次，永久锁死 0 次
- 安全层把非零命令改成零：0 次（配对命令 4503 条）
- 性能采样：382 条；最高温度 64.1°C；监控唤醒延迟 P95 5.3 ms
...
- FAST-LIO 多核证据：进程 CPU 峰值 116%，线程数最多 11，线程实际落到的 CPU=[0, 1, 2, 3, 4, 5, 6, 7]，允许 CPU=["0-7"]
...
- FAST-LIO 与狗身 IMU 相对姿态：可比较；相对 R/P/Y 中位数=5.57°/11.66°/-21.33°；相对姿态变化 P95=33.77°/17.78°/16.73°
- 狗底层：电机最高温度 44°C；电池功率 P95 197.2W；Sport 非零错误 4784 条；motor lost 0 条
