...
- 生成时间：2026-07-25T18:31:33.885+08:00
- 运行目录：`/home/unitree/go2_fastlio_ws/patrol_logs/runs/20260725/xunjian-20260725-12`
- 证据流是否完整：是
- 完整体检材料是否齐全：否
...
- 坐标转换可精确复算：是
- 起步位置误差：0.006 m；起步朝向误差：0.029°
- 全程横向误差：中位 0.732 m，P95 2.136 m，最大 2.539 m
- 前 5m 横向误差：P95 0.207 m，最大 0.222 m
- 跟线器逐周期证据：14451 条控制决策、使用 6915 个里程计回调；同一里程计连续复用最多 9 个控制周期；里程计时间戳年龄 P95 454.9 ms
- 全速 rosbag 关键话题：齐全；各话题消息数={"/Odometry": 7109, "/api/sport/request": 14764, "/cmd_vel": 14761, "/lf/sportmodestate": 14860, "/livox/imu": 148500, "/patrol_cmd": 14672, "/tf": 7110}
- rosbag 里程计最大记录间隔：0.447 s
- FAST-LIO 活性事件：自动恢复 0 次，健康失败 0 次，永久锁死 0 次
- 安全层把非零命令改成零：24 次（配对命令 9066 条）
- 性能采样：753 条；最高温度 65.3°C；监控唤醒延迟 P95 4.7 ms
...
- FAST-LIO 多核证据：进程 CPU 峰值 154.9%，线程数最多 11，线程实际落到的 CPU=[0, 1, 2, 3, 4, 5, 6, 7]，允许 CPU=["0-7"]
...
- FAST-LIO 与狗身 IMU 相对姿态：可比较；相对 R/P/Y 中位数=-2.5°/26.77°/-21.89°；相对姿态变化 P95=33.47°/45.83°/16.38°
- 狗底层：电机最高温度 49°C；电池功率 P95 178.2W；Sport 非零错误 9470 条；motor lost 2944 条
